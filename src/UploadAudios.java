...
public class UploadAudios {
    ...
    public static void main(String[] args) {
        String audioId = "222";
        String audioTitle = "my_song_2";
        String dataPath = "D:/ACRTest/test/my_song_2.mp3";
        String dataType = "audio"; // audio & fingerprint
        String bucketName = "MusicBucket";
        String accessKey = "8c85b19fc3ec2cb31ded2eed662d7eeb";
        String accessSecret = "fK4wVKtniCZ0r30Bki75qeAWqzgqniEiPdU0UPK9";
